      ...
      <div className="w-full max-w-4xl gap-6">
        ...
        <div className="w-full my-7 flex justify-between items-center">
          ...
          {/* Add to Cart Button */}
            ...
            <Button className="mt-3 w-[135px] md:w-[200px] h-[35px] md:h-[60px] bg-blue-600 hover:bg-blue-700 text-white text-lg py-3 rounded-xl shadow-md transition-all duration-200">
            🛒 Add to Cart
          </Button>
          </div>
        </div>
